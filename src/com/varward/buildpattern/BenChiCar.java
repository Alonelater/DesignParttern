...
public class BenChiCar extends  BuildCar {
    ...
    void bulidCarWheel(String wheel) {
        ...
        System.out.println("奔驰车建造中，使用的是"+wheel+"轮毂");
    }

    @Override
    void bulidCarDoor(String color) {
        car.setCarDoor(color);
        System.out.println("奔驰车建造中，使用的是"+color+"颜色的门");
    }

    @Override
    void bulidCarEngine(String engine) {
        car.setCarEngine(engine);
        System.out.println("奔驰车建造中，使用的是"+engine+"的发动机");
    }
